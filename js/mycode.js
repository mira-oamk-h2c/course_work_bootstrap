...
$(document).ready(function () {
  ...
  */
  function validateInput(birthYear, weight, height) {
  ...
  $("#calculate_bmi").click(function () {
    ...
    if (validateInput(birthYear, weight, height) === false) { 
    ...
    if (age < 20 || age > 60) {
      ...
      $("#m_body").html("<p>" + "BMI results are for people from age 20 to 60." + "</p>");
      let message = new bootstrap.Modal(document.getElementById("mymessage"),
        { backdrop: "static" }
      );
      message.show();
  ...
  // Select and empty all output elements with click on input element "Weight"
